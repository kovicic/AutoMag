...
#define   SRCLK 25   //shift register clock input(SHCP)
...
unsigned char code_L[8] = {0xf,0xf,0xc,0xd,0xd,0x3,0xf,0xf};
unsigned char code_H[8] = {0x0,0x1,0x4,0x4,0x4,0x4,0x8,0x0};
